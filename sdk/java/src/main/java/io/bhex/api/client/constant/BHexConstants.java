...
public class BHexConstants {
    ...
    public static final String API_BASE_URL = "https://api.bitreet.com/";

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = "wss://wsapi.bitreet.com/openapi/quote/ws/v1";

    public static final String WS_API_USER_URL = "wss://wsapi.bitreet.com/openapi/ws/";
